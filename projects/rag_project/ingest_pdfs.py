...
# -*- coding: utf-8 -*-
"""
Extract text from local PDFs into JSONL for RAG.

Two modes:
- Whole-document (default): one JSON per PDF with joined text of all pages.
- Per-page (--per-page): one JSON per page with page text, preserving metadata.

Schema (whole-document):
{
  "url": "file:///abs/path/to/file.pdf",
  ...
  "id": "file:///abs/path/to/file.pdf|timestamp"
}

Schema (per-page):
{
  "url": "file:///abs/path/to/file.pdf#page=7",
  "title": "...",
  "author": "...",
  "date": "...",
  "text": "... page text ...",
  ...
  "language": "es",
  "scraped_at": "UTC ISO time",
  "id": "file:///abs/path/to/file.pdf#page=7|timestamp"
}

Usage examples:
  python projects/rag_project/ingest_pdfs.py \
    --input-dir /path/to/pdfs \
    --out projects/rag_project/corpus/pdfs.jsonl

  python projects/rag_project/ingest_pdfs.py \
    --input-dir /path/to/pdfs \
    --out projects/rag_project/corpus/pdfs_pages.jsonl \
    --per-page
"""
